...
PostgreSQL storage for strategy validation results and performance data.
"""
...
from ..evaluation.strategy_evaluator import EvaluationMetrics
...
class ValidationResult:
    ...
    # Scoring metrics
    scoring_metrics: ScoreBreakdown
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'ValidationResult':
        ...
        performance_metrics = EvaluationMetrics.from_dict(data['performance_metrics'])
        
        # Create scoring metrics
        scoring_metrics = ScoreBreakdown.from_dict(data['scoring_metrics'])
        ...
        return cls(
            ...
            backtest_duration_days=data['backtest_duration_days'],
            total_trades=data['total_trades']
        )


class ValidationStorage:
    """PostgreSQL storage for validation results"""
    ...
    def __init__(self, connection_string: str):
        ...
        self.logger.info("ValidationStorage initialized")
    ...
    async def store_validation_result(self, result: ValidationResult) -> bool:
        ...
        try:
            async with asyncpg.connect(self.connection_string) as conn:
                ...
                json.dumps(result.performance_metrics.to_dict()),
                json.dumps(result.scoring_metrics.to_dict()),
            ...
            async with asyncpg.connect(self.connection_string) as conn:
                ...
                for row in rows:
                    result = ValidationResult(
                        ...
                        performance_metrics=EvaluationMetrics.from_dict(
                            json.loads(row['performance_metrics'])
                        ),
                        scoring_metrics=ScoreBreakdown.from_dict(
                            json.loads(row['scoring_metrics'])
                        ),
