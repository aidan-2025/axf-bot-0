#!/usr/bin/env python3
"""
Simple Validation Storage

Simplified PostgreSQL storage service for strategy validation results.
"""
...
class SimpleValidationStorage:
    """Simplified PostgreSQL storage for validation results"""
    ...
    def __init__(self, connection_string: str):
        ...
        self.logger.info("SimpleValidationStorage initialized")
    ...
    async def cleanup_old_results(self, days_to_keep: int = 30) -> int:
        ...
        try:
            ...
            result = await conn.execute(f"""
                ...
                WHERE validation_timestamp < NOW() - INTERVAL '{days_to_keep} days'
            """)
