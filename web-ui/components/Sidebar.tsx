...
const navigation = [
  ...
  { name: 'Market Insights', href: '/market', icon: ChartPieIcon },
  { name: 'Strategy Generator', href: '/generator', icon: DocumentTextIcon },
  { name: 'EA Generator', href: '/ea-generator', icon: CogIcon },
        ...
        <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              <h1 className="text-xl font-bold text-primary-600">AXF Bot 0</h1>
            </div>
